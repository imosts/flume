// -*-c++-*-
/* $Id: circbuf.h 2148 2006-08-11 20:09:48Z max $ */
...
#ifndef _LIBFLUME_CIRCBUF_H
#define _LIBFLUME_CIRCBUF_H 1
...
//      from dep[0] to rp.
//    - data is read out of the circbuf from rp to dep[1]
...
class circbuf_t {
public:
  circbuf_t (int l = SUIOLITE_DEF_BUFLEN, cbv::ptr s = NULL) 
