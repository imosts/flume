...
'''Login and try again.''':
'''Ingresa al sistema e inténtalo nuevamente.''',
...
'''No puedes renombrar hacia una página sin nombre.''',
...
'''Ejecutar la acción  %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''La accion %(actionname)s no está presente en este wiki!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''No tienes permisos para usar la acción %(actionname)s en esta página.''',
