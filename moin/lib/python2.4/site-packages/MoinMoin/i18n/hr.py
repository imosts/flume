...
'''Login and try again.''':
''' Prijavite se i pokušajte ponovno.''',
...
'''Ne možete promijeniti ime u prazno.''',
...
'''Izvrši akciju %(actionname)s''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Akcija %(actionname)s nije uključena na ovom wikiju!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''Ne možete koristiti akciju %(actionname)s na ovoj stranici.''',
