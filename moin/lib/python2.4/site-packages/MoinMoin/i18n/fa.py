...
'''(از نام \'\'\'\'\'\' و نام خانوادگی به زبان انگلیسی و طبق الگوی صحیح استفاده نمایید)''',
'''Alias-Name''':
'''نام مستعار''',
'''Password repeat''':
'''تکرار کلمه عبور''',
...
'''عملیات %(actionname)s انجام شود؟''',
'''Action %(actionname)s is excluded in this wiki!''':
'''عملیات %(actionname)s در این ویکی غیر مجاز است!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''عملیات %(actionname)s روی این صفحه مجاز نیست!''',
