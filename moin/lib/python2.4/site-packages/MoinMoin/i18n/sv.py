...
'''Du kan inte byta ett tomt sidnamn.''',
...
'''Utför åtgärd %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Åtgärd %(actionname)s är exkluderad i den här wikin!''',
...
'''Var god använd det interaktiva användargränsnittet för att utföra åtgärd %(actionname)s!''',
'''Title Search: "%s"''':
'''Titelsökning: "%s"''',
'''Full Text Search: "%s"''':
'''Fulltextsökning: "%s"''',
