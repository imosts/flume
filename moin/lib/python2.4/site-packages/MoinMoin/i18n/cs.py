...
'''Login and try again.''':
'''Přihlašte se a zkuste to znovu.''',
...
'''Tato stránka je nyní \'\'zamčena\'\' kvůli editaci uživatele %(owner)s až do %(timestamp)s, flmn. na maximálně dalších %(mins_valid)d minut.''',
...
'''Balíček vyžaduje novější verzi MoinMoin (alespoň %s).''',
'''The theme name is not set.''':
'''Název vzhledu není nastaveno.''',
...
'''Stránka %s neexistuje.''',
'''Invalid package file header.''':
'''Neplatná hlavička balíčku.''',
'''Package file format unsupported.''':
'''Formát balíčku není podporován.''',
'''Unknown function %(func)s in line %(lineno)i.''':
'''Neznámá funkce %(func)s na řádku %(lineno)i.''',
'''The file %s was not found in the package.''':
'''Soubor %s nebyl v balíčku nalezen.''',
...
'''Vytvořen balíček %s obsahující stránky %s.''',
'''Package pages''':
'''Zbalit stránky''',
'''Package name''':
'''Název balíčku''',
'''List of page names - separated by a comma''':
'''Seznam názvů stránek oddělených čárkou''',
'''Unknown user name: {{{"%s"}}}. Please enter user name and password.''':
'''Neznámé uživatelské jméno: {{{"%s"}}}. Prosím vložte jméno a heslo.''',
'''Missing password. Please enter user name and password.''':
'''Prázdné heslo. Prosím vložte jméno a heslo.''',
'''Sorry, wrong password.''':
'''Promiňte, špatné heslo.''',
...
'''Please log in first.''':
'''Nejdříve se přihlašte.''',
'''Please first create a homepage before creating additional pages.''':
'''Prosím, nejdříve vytvořte domovskou stránku.''',
...
||\'\'\'Přidat novou osobní stránku:\'\'\'||\'\'\'Související stránka řídící přístup:\'\'\'||
||[[NewPage(HomepageReadWritePageTemplate,read-write page,%(username)s)]]||["%(username)s/ReadWriteGroup"]||
||[[NewPage(HomepageReadPageTemplate,read-only page,%(username)s)]]||["%(username)s/ReadGroup"]||
||[[NewPage(HomepagePrivatePageTemplate,private page,%(username)s)]]||%(username)s only||
...
'''Spustit akci %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Akce %(actionname)s je v této wiki vyloučena!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''Nemáte dovoleno spustit na této stránce akci %(actionname)s!''',
...
'''Obnovení ze zálohy: %(filename)s do adresáře: %(targetdir)s neproběhlo úspěšně.''',
'''Wiki Backup / Restore''':
'''Záloha / Obnova Wiki''',
'''Some hints:
 * To restore a backup:
 ...
 * Jak obnovit zálohu:
  ...
  * Přejmenujte záložní soubor na <siteid>.tar.<compression> (odstraňte --date--time--UTC).
  * Vložte záložní soubor do backup_storage_dir.
  * Stiskněte tlačítko [[GetText(Restore)]] níže.

 * Jak vytvořit zálohu:
  * Stačí stisknout tlačítko [[GetText(Backup)]] níže a uložit získaný soubor na bezpečném místě.

Zajistěte prosím správné a kompletní nastavení backup_* hodnot v konfiguraci.
''',
'''Backup''':
'''Záloha''',
'''Restore''':
...
'''Nemáte dovoleno provést vzdálenou zálohu.''',
'''Unknown backup subaction: %s.''':
'''Neznámá podakce zálohy: %s.''',
'''[%d attachments]''':
'''[%d přílohy]''',
...
'''Neplatné MonthCalendar calparms "%s"!''',
'''Invalid MonthCalendar arguments "%s"!''':
'''Neplatné MonthCalendar argumenty "%s"!''',
