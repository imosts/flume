...
'''Der Inhalt der leflmten Sicherungskopie ist veraltet und wird von der Volltextsuche ignoriert!''',
...
Um das Formular auf anderen Seiten zu benuflmen, muss folgender Makroaufruf
[[BR]][[BR]]\'\'\'{{{    [[Form("%(pagename)s")]]}}}\'\'\'[[BR]][[BR]]
auf diesen Seiten plaflmiert werden.-~
''',
'''Create New Page''':
'''Neue Seite anlegen''',
...
'''Page is immutable!''':
'''Die Seite ist gegen Änderungen geschüflmt!''',
...
'''Ein anderer Benuflmer hat diese Seite inzwischen gelöscht!''',
'''Someone else changed this page while you were editing!''':
'''Ein anderer Benuflmer hat diese Seite inzwischen geändert!''',
'''Someone else saved this page while you were editing!
Please review the page and save then. Do not save this page as it is!
Have a look at the diff of %(difflink)s to see what has been changed.''':
'''Ein anderer Benuflmer hat gespeichert, während Sie editiert haben!
...
Wenn Sie Ihr Passwort vergessen haben, benuflmen Sie bitte die Daten unten und
geben Sie das Passwort GENAUSO WIE ANGEZEIGT in das Passwort-Feld des Wikisein (benuflmen Sie kopieren und einfügen dazu).

Nachdem Sie sich erfolgreich angemeldet haben, seflmen Sie bitte Ihr Passwort neu.
''',
...
'''Es wurde kein Benuflmerkonto mit der E-Mail-Adresse \'%(email)s\' gefunden!''',
'''Use UserPreferences to change your settings or create an account.''':
'''Benuflmen Sie BenuflmerEinstellungen, um Ihre Einstellungen zu ändern oder ein Konto zu erzeugen.''',
'''Empty user name. Please enter a user name.''':
'''Leerer Benuflmername, bitte geben Sie einen Benuflmernamen ein.''',
'''This user name already belongs to somebody else.''':
'''Dieser Benuflmername gehört bereits jemand anderem.''',
...
'''Es wurde ein Benuflmerkonto für Sie angelegt. Sie können sich nun anmelden...''',
'''Use UserPreferences to change settings of the selected user account''':
'''Benuflmen Sie BenuflmerEinstellungen, um die Einstellungen des ausgewählten Benuflmers zu ändern.''',
...
'''Installierte Prozessoren (veraltet) -- benuflmen Sie stattdessen Parser)''',
'''Disabled''':
'''Deaktiviert''',
'''Enabled''':
'''Aktiviert''',
...
'''Anderen Benuflmern wird die Editierung dieser Seite bis %(bumptime)s \'\'verweigert\'\'.''',
'''Other users will be \'\'warned\'\' until %(bumptime)s that you are editing this page.''':
'''Andere Benuflmer erhalten bis %(bumptime)s eine \'\'Warnung\'\', dass Sie diese Seite editieren.''',
...
'''Diese Seite wurde zum leflmten Mal um %(timestamp)s durch %(owner)s zum Editieren geöffnet
...
Benuflmen Sie "Abbrechen" zum Verlassen des Editors.''',
...
'''Theme-Name ist nicht geseflmt.''',
'''Installing theme files is only supported for standalone type servers.''':
'''Das Installieren von Theme-Dateien wird nur für Server-Typ standalone unterstüflmt.''',
...
'''Paket-Datei-Format nicht unterstüflmt.''',
...
'''Springe zur leflmtbesuchten Seite anstatt zur Startseite''',
...
'''Dieses Benuflmerkonto für immer deaktivieren''',
...
'''Leer lassen, um benuflmerdefiniertes CSS auszuschalten)''',
'''Editor size''':
...
'''Nachfolgende Benuflmer haben diese Seite abonniert:''',
...
'''Fügen Sie Ihre E-Mail-Adresse in den BenuflmerEinstellungen hinzu, um Abonnements benuflmen zu können.''',
...
'''Editieren Sie die regulären Ausdrücke für Abonnements in Ihren BenuflmerEinstellungen.''',
...
'''Unbekannter Benuflmername: {{{"%s"}}}. Bitte geben Sie Benuflmername und Passwort ein.''',
'''Missing password. Please enter user name and password.''':
'''Fehlendes Passwort. Bitte geben Sie Benuflmername und Passwort ein.''',
...
''':
'''Hier können Sie zusäflmliche Unterseiten zu Ihrer bereits existierenden Homepage hinzufügen.
...
Bevor Sie zugriffsgeschüflmte Seiten erzeugen, stellen Sie sicher, dass die entsprechende Gruppenseite existiert und die richtigen Mitglieder hat. Benuflmen Sie HomepageGroupsTemplate für das Erzeugen der Gruppenseiten.
...
'''Sie dürfen die Aktion %(actionname)s auf dieser Seite nicht benuflmen!''',
'''Please use the interactive user interface to use action %(actionname)s!''':
'''Für die Aktion %(actionname)s bitte nur die vorgesehenen Webseiten benuflmen!''',
'''Title Search: "%s"''':
'''Titelsuche: "%s"''',
'''Full Text Search: "%s"''':
'''Volltextsuche: "%s"''',
...
'''Seite %s für Benuflmer abonnieren''',
'''Subscribed for %s:''':
'''Abonnenten von %s:''',
'''Not a user:''':
'''Kein Benuflmer:''',
...
wie \'\'\'{{{attachment:dateiname}}}\'\'\' benuflmt werden, 
wie sie auch in der folgenden Liste der Dateien erscheint. 
Es sollte \'\'\'niemals\'\'\' die URL des Verweises ("laden") kopiert werden, 
da sich diese jederzeit ändern kann und damit der Verweis auf die Datei brechen würde.''',
'''unzip''':
'''auspacken''',
'''install''':
'''installieren''',
...
Ansonsten kann das Feld "Speichern unter..." leer bleiben und es wird der originale Dateiname benuflmt.''',
'''File to upload''':
'''Neuer Dateianhang''',
'''Rename to''':
'''Umbenennen auf''',
...
'''Dieser Anhang besiflmt einen unbekannten Dateityp und kann deshalb nicht direkt angezeigt werden.''',
...
'''zuleflmt geändert am %(time)s durch %(editor)s''',
'''last modified %(time)s''':
'''zuleflmt geändert %(time)s''',
'''Search:''':
'''Suchen:''',
'''Text''':
'''Text''',
...
'''Oder benuflme eine dieser Aktionen:''',
'''Page''':
'''Seite''',
'''User''':
'''Benuflmer''',
