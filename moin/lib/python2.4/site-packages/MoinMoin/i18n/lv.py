...
Lietotāja vārds drīkst saturēt \'\'Unicode\'\' burflmīmes un ciparus un, ja nepieciešams, vienu atstarpi starp vārdiem.
Grupas lapas vārds nav atļauts.''',
'''You are not allowed to do %s on this page.''':
'''Jūs nedrīkstat veikt %s ar šo lapu.''',
'''Login and try again.''':
'''Pieslēdzieties un mēģiniet vēlreiz.''',
...
Ja Jūs esat aizmirsis paroli, lūdzu ievadiet šos datus un paroli KĀ NORĀDĪTS ŠEIT
 (izmantojiet kopēt/ielīmēt(copy/paste), lai dati būtu precīzi).

Pēc veiksmīgas ieiešanas sistēmā vēlams nomainītu veco paroli un izveidot jaunu.
''',
...
'''Lapas nosaukums nedrīkst būt tukšs.''',
...
''' Uzvērt:: [[Verbatim(\'\')]]\'\'kursīvā\'\'[[Verbatim(\'\')]]; [[Verbatim(\'\'\')]]\'\'\'treknrakstā\'\'\'[[Verbatim(\'\'\')]]; [[Verbatim(\'\'\'\'\')]]\'\'\'\'\'treknā kursīvā\'\'\'\'\'[[Verbatim(\'\'\'\'\')]]; [[Verbatim(\'\')]]\'\'jaukti \'\'[[Verbatim(\'\'\')]]\'\'\'\'\'treknrakstā\'\'\'[[Verbatim(\'\'\')]] un kursīvā\'\'[[Verbatim(\'\')]]; [[Verbatim(----)]] horizontāla svītra.
 ...
 Saraksti:: tukšums un kāds no: * aflmīmes simboli; 1., a., A., i., I. numurēti elementi; 1.#n sākot no n; viens tukšums  - atkāpes.
...
Saraksti: * aflmīmes; 1., a. numurēti elementi.
</pre>
<br/>
...
'''Pievienot aflmīmētos vārdus vārdnīcai''',
...
'''Vai veikt darbību %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Darbība %(actionname)s ir veikta šajā Viki!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''Jums nav tiesību izmantot darbību %(actionname)s šajā lapā.''',
'''Please use the interactive user interface to use action %(actionname)s!''':
'''Darbību %(actionname)s, lūdzu, izmantojiet interaktīvi!''',
'''Title Search: "%s"''':
'''Meklēt virsrakstus: "%s"''',
'''Full Text Search: "%s"''':
...
'''Dzēstie aflmīmēti šādi.''',
'''Additions are marked like this.''':
'''Pievienotie aflmīmēti šādi''',
