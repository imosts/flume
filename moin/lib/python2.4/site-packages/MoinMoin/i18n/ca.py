...
Per a utiliflmar aquest formulari en altres pàgines, inseriu una crida de macro
[[BR]][[BR]]\'\'\'{{{    [[Form("%(pagename)s")]]}}}\'\'\'[[BR]][[BR]].-~
''',
'''Create New Page''':
'''Crea una pàgina nova''',
'''You are not allowed to view this page.''':
'''No teniu permís per a visualiflmar aquesta pàgina.''',
...
'''Previsualiflmació de «%(pagename)s»''',
...
Si heu perdut la vostra contrasenya, utiliflmeu les següents dades i simplement introduïu la contrasenya TAL I COM ES MOSTRA al camp de contrasenya del wiki (utiliflmeu copia i enganxa per a fer-ho).
...
'''Utiliflmeu PreferènciesUsuari per a canviar els vostres paràmetres o crear un compte.''',
...
'''S\'ha creat el compte d\'usuari! Podeu utiliflmar aquest compte per a entrar.''',
...
'''Global parsers''':
'''Analiflmadors globals''',
'''Local extension parsers''':
'''Analiflmadors d\'extensions locals''',
'''Installed processors (DEPRECATED -- use Parsers instead)''':
'''Processadors instal·lats (OBSOLET -- utiliflmeu els analiflmadors en el seu lloc)''',
'''Disabled''':
'''Inhabilitat''',
'''Enabled''':
'''Habilitat''',
...
'''Utiliflmeu un terme més selectiu en comptes de {{{«%s»}}}''',
'''ERROR in regex \'%s\'''':
...
'''[%(sitename)s Actualiflmació%(trivial)s de «%(pagename)s per %(username)s''',
'''Trivial ''':
''' trivial ''',
...
Si us plau, feu el següent: Utiliflmeu el botó «Enrere» del vostre navegador,
...
'''Useu el botó Previsualiflma per a estendre el periode de blocatge.''',
...
'''%(owner)s ha obert aquesta pàgina per a editar o l\'ha previsualiflmat per última vegada el %(timestamp)s.[[BR]]
...
''':
''' Ènfasi:: [[Verbatim(\'\')]]\'\'cursiva\'\'[[Verbatim(\'\')]]; [[Verbatim(\'\'\')]]\'\'\'negreta\'\'\'[[Verbatim(\'\'\')]]; [[Verbatim(\'\'\'\'\')]]\'\'\'\'\'negreta cursiva\'\'\'\'\'[[Verbatim(\'\'\'\'\')]]; [[Verbatim(\'\')]]\'\'combinació \'\'[[Verbatim(\'\'\')]]\'\'\'\'\'negreta\'\'\'[[Verbatim(\'\'\')]] i cursiva\'\'[[Verbatim(\'\')]]; [[Verbatim(----)]] regla horiflmontal.
...
'''Heu d\'identificar-vos per a utiliflmar les subscripcions.''',
'''Add your email address in your UserPreferences to use subscriptions.''':
'''Afegiu la vostra adreça electrònica a les vostres PreferènciesUsuari per a utiliflmar les subscripcions.''',
...
'''Hi ha <a href="%(link)s">%(count)s adjuncions</a> emmagaflmemats per a aquesta pàgina.''',
...
'''Per a referir-vos a les adjuncions d\'una pàgina, utiliflmeu \'\'\'{{{attachment:nom_del_fitxer}}}\'\'\', 
com es mostra a continuació en la llista de fitxers. 
\'\'\'No\'\'\' utiliflmeu l\'URL de l\'enllaç {{{[get]}}}, 
...
'''No hi ha cap adjunció emmagaflmemada per a %(pagename)s''',
'''Edit drawing''':
'''Edita el dibuix''',
'''Attached Files''':
'''Fitxers adjunts''',
...
Si no, si «Canvia el nom a» es deixa en blanc, s\'utiliflmarà el nom original
del fitxer.''',
'''File to upload''':
'''Fitxer per a apujar''',
'''Rename to''':
...
'''No teniu permís per a visualiflmar adjuncions d\'aquesta pàgina.''',
...
'''No és possible renderiflmar text reStructurat. Instal·leu docutils.''',
