...
'''Login and try again.''':
'''Prijavite se in poskusite ponovno.''',
...
'''Ali naj se izvede akcija %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Akcije %(actionname)s ta viki ne dovoljuje!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''Akcija %(actionname)s nad to stranjo vam ni dovoljena!''',
'''Please use the interactive user interface to use action %(actionname)s!''':
'''Za akcijo %(actionname)s uporabite interaktivni uporabniški vmesnik!''',
'''Title Search: "%s"''':
