...
'''Luodaksesi tunnuksen tai selvittääksesi kadonneen salasanan, käytä sivua %(userprefslink)s.''',
'''Name''':
'''Nimi''',
'''Password''':
'''Salasana''',
...
'''Käytetty levytila hakemistossa %(data_dir)s/pages/''',
'''Disk usage of %(data_dir)s/''':
'''Käytetty levytila hakemistossa %(data_dir)s/''',
'''Entries in edit log''':
...
'''Paketti tarvitsee uudemman version MoinMoinista (vähintään %s).''',
'''The theme name is not set.''':
'''Teeman nimeä ei ole asetettu.''',
...
'''Kelvoton pakettitiedoston otsake.''',
'''Package file format unsupported.''':
'''Paketin tiedostomuoto ei ole tuettu.''',
'''Unknown function %(func)s in line %(lineno)i.''':
'''Tuntematon funktio %(func)s rivillä %(lineno)i.''',
'''The file %s was not found in the package.''':
'''Tiedostoa %s ei ollut paketissa.''',
...
'''Luotu paketti %s sivuista %s.''',
'''Package pages''':
'''Paketoi sivuja''',
'''Package name''':
'''Paketin nimi''',
'''List of page names - separated by a comma''':
'''Luettelo sivuista - pilkuilla erotettuina''',
...
'''Luo kotisivu ennen kuin luot muita sivuja.''',
'''Rename Page''':
...
'''Suorita toiminto %(actionname)s?''',
'''Action %(actionname)s is excluded in this wiki!''':
'''Toiminto %(actionname)s on suljettu pois tässä wikissä!''',
'''You are not allowed to use action %(actionname)s on this page!''':
'''Sinun ei ole sallittu käyttää toimintoa %(actionname)s tällä sivulla!''',
'''Please use the interactive user interface to use action %(actionname)s!''':
'''Käytä toimintoa %(actionname)s vuorovaikutteisessa käyttöliittymässä!''',
'''Title Search: "%s"''':
'''Nimihaku: "%s"''',
'''Full Text Search: "%s"''':
'''Tekstihaku: "%s"''',
...
'''Uutta sivua ei voi luoda ilman sivun nimeä. Anna sivulle nimi.''',
'''Pages''':
'''Sivut''',
'''Select Author''':
'''Valitse kirjoittaja''',
...
'''Sinun ei ole sallittu käyttää tätä toimintoa.''',
'''Subscribe users to the page %s''':
'''Tilaa sivua %s käyttäjille''',
'''Subscribed for %s:''':
'''%s tilattuna käyttäjille:''',
'''Not a user:''':
'''Ei käyttäjä:''',
'''You are not allowed to perform this action.''':
'''Sinun ei ole sallittu suorittaa tätä toimintoa.''',
...
'''Varmuuskopion palauttaminen ei onnistunut: %(filename)s kohdehakemistoon: %(targetdir)s.''',
'''Wiki Backup / Restore''':
'''Wikin varmuuskopiointi / palautus''',
'''Some hints:
 * To restore a backup:
 ...
 * Varmuuskopion palauttaminen:
  * Varmuuskopion palauttaminen ylikirjoittaa senhetkiset tiedot, joten ole varovainen.
  * Vaihda varmuuskopion nimeksi <sivusto>.tar.<pakkaus> (poista --päiväys--aika--UTC -osuus).
  * Laita varmuuskopio hakemistoon backup_storage_dir (scp:llä, ftp:llä, ...).
  * Paina nappia [[GetText(Restore)]] alapuolella.

 * Varmuuskopion luodaksesi paina vain nappia [[GetText(Backup)]] ja tallenna 
   saamasi tiedosto varmaan paikkaan.

Kannattaa varmistaa että wikin asetusten arvot backup_* ovat oikeat ja kattavat.
...
'''Sinun ei ole sallittu ottaa etävarmuuskopioita.''',
'''Unknown backup subaction: %s.''':
'''Tuntematon varmistuksen osatoiminto: %s.''',
'''[%d attachments]''':
'''[liitetiedostoja %d]''',
...
'''Kelvottomat KuukausiKalenterin parametrit "%s"!''',
