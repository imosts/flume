...
def _importConfigModule(name):
    ...
    """
    try:
        # FIXME if someone calls his config module stats.py, it gets confused
        # with MoinMoin.stats built-in statistics module and fails.
...
"""),
    ...
    theme_force = False
    trail_size = 5
    flm_offset = 0.0 # default time zone offset in hours from UTC
    ...
    ua_spiders = ('archiver|cfetch|crawler|curl|francis|gigabot|googlebot|holmes|htdig|httrack|httpunit|jeeves|larbin|leech|'
                  'linkbot|linkmap|linkwalk|mercator|mirror|msnbot|neomo|nutbot|omniexplorer|puf|robot|scooter|seekbot|'
                  'sherlock|slurp|sitecheck|spider|onetszukaj|teleport|voyager|webreaper')
    ...
    # Flume options
    count_hits = True
    use_global_event_log = True
    use_flumegroupdict = False
    use_i18n = True
    usermgruid = None
    usermgr = None
    show_last_editor = True
    use_trails = True
    use_pagecache = True
    make_backups = True
    page_dir = data_dir
    ...
    def __init__(self, siteid):
        ...
        self.moinmoin_dir = os.path.abspath(MoinMoin.request.prefix)
        ...
        # YIPAL: If your directories are wrong, you're stupid.
        # Cutting this will trim a bunch of RPCs as well!
