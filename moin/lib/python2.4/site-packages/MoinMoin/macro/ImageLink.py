...
"""
    ...
    Examples:
        ...
        [[ImageLink(http://webcam.portalmuc.de/images/webcam/webcam_marienplaflm.jpg,München Marienplaflm)]]
        [[ImageLink(plot.png,width=200)]]
        [[ImageLink(plot.png,height=200)]]
        [[ImageLink(plot.png)]]
        [[ImageLink(http://webcam.portalmuc.de/images/webcam/webcam_marienplaflm.jpg,http://www.muenchen.de,width=150)]]
        [[ImageLink(münchen.png,http://www.muenchen.de,width=50)]]
        [[ImageLink(http://webcam.portalmuc.de/images/webcam/webcam_marienplaflm.jpg)]]
